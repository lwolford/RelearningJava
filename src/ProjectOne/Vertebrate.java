 ...
 * Vertebrate class
 * Subclass of Animal
 * Superclass of Mammal, Bird, Fish, Reptile, and Amphibian
 * Defines animal of type Vertebrate
 */
...
public class Vertebrate extends Animal {
    ...
    public Vertebrate(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Vertebrate overrides the speak() method inside of Animal
    ...
    public String speak() {
        ...
        strSpeakInformation += "I also have a backbone!";
