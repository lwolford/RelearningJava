...
public class Bird extends Vertebrate {
    ...
    public Bird(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Bird overrides the speak() method inside of Vertebrate
    ...
    public String speak() {
        ...
        if (intNumberOfLegs == 0) strSpeakInformation += "This makes me sad but at least I have wings. ";
        else strSpeakInformation += "Having legs is amazing but having wings is even better! ";
