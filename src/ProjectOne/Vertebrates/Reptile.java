 ...
 * Defines animal of type Reptile
 */
public class Reptile extends Vertebrate {
    ...
    public Reptile(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Reptile overrides the speak() method inside of Vertebrate
    ...
    public String speak() {
        ...
        if (intNumberOfLegs == 0) strSpeakInformation += "This makes me sad. No scaly legs for me. ";
        else strSpeakInformation += "Having legs is amazing ... especially when they're scaly! ";
