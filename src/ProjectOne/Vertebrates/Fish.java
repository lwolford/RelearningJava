...
public class Fish extends Vertebrate {
    ...
    public Fish(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Fish overrides the speak() method inside of Vertebrate
    ...
    public String speak() {
        ...
        strSpeakInformation += "Quote: Glug glug";
