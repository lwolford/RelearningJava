...
public class Mammal extends Vertebrate {
    ...
    public Mammal(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Mammal overrides the speak() method inside of Vertebrate
    ...
    public String speak() {
        ...
        if (intNumberOfLegs == 0) strSpeakInformation += "This makes me sad. ";
        else strSpeakInformation += "Having legs is amazing. ";
