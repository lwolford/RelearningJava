...
public class Bug extends Invertebrate {
    ...
    public Bug(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in Bug overrides the speak() method inside of Invertebrate
    ...
    public String speak() {
        ...
        strSpeakInformation += "Quote: I have " + intNumberOfLegs + " legs. " + intNumberOfLegs + " is easily the best number of legs";
