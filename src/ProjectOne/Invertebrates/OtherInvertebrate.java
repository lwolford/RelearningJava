package ProjectOne.Invertebrates;

import ProjectOne.Invertebrate;

/**
 * OtherInvertebrate class
 * Subclass of invertebrate
 * Defines animal of type OtherInvertebrate
 */
public class OtherInvertebrate extends Invertebrate {
    ...
    public OtherInvertebrate(String strName, int intHasHair, int intHasFeathers, int intHasEggs, int intHasMilk,
    ...
    /**
     * speak() in OtherInvertebrate overrides the speak() method inside of Invertebrate
    ...
    public String speak() {
        ...
        strSpeakInformation += "Quote: I sadly don't have any legs.";
        if (intNumberOfLegs > 0) strSpeakInformation += ".. Oh wait I do have legs. " + intNumberOfLegs + " to be exact.";
